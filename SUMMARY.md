...
* [Developer Guide](java/developer-guide/README.md)
  * [DIDBackend](java/developer-guide/didbackend/README.md)
    * [Initialize the DIDBackend](java/developer-guide/didbackend/initialize-the-didbackend.md)
  ...
  * [RootIdentity](java/developer-guide/rootidentity/README.md)
    * [Create RootIdenenty](java/developer-guide/rootidentity/create-rootidenenty.md)
  ...
  * [Advanced](java/developer-guide/advanced/README.md)
    * [How to create your own DID adapter](java/developer-guide/advanced/how-to-create-your-own-did-adapter.md)
  ...
  * [Credential and presentation](java/developer-guide/credential-and-presentation/README.md)
    ...
    * [Publish credential](java/developer-guide/credential-and-presentation/publish-credential.md)
    * [Resolve the published credentials](java/developer-guide/credential-and-presentation/resolve-the-published-credentials.md)
    * [Verify the integrity of credential](java/developer-guide/credential-and-presentation/verify-the-integrity-of-credential.md)
    ...
    * [How to use and verify the presentation](java/developer-guide/credential-and-presentation/how-to-use-and-verify-the-presentation.md)
...
* [Developer Guide(with sample code)](swift/developer-guide-with-sample-code/README.md)
  * [DIDBackend](swift/developer-guide-with-sample-code/didbackend/README.md)
    * [initialize the DIDBackend](swift/developer-guide-with-sample-code/didbackend/initialize-the-didbackend.md)
  * [DIDStore](swift/developer-guide-with-sample-code/didstore/README.md)
    * [Create or open DIDStore](swift/developer-guide-with-sample-code/didstore/create-or-open-didstore.md)
    * [Access DIDStore](swift/developer-guide-with-sample-code/didstore/access-didstore.md)
    * [Export/import DID](swift/developer-guide-with-sample-code/didstore/export-import-did.md)
    * [RootIdentity](swift/developer-guide-with-sample-code/didstore/rootidentity/README.md)
      * [Create RootIdenenty](swift/developer-guide-with-sample-code/didstore/rootidentity/create-rootidenenty.md)
      * [Create DIDs from the RootIdentity](swift/developer-guide-with-sample-code/didstore/rootidentity/create-dids-from-the-rootidentity.md)
  * [DID](swift/developer-guide-with-sample-code/did/README.md)
    * [Resolve DIDs](swift/developer-guide-with-sample-code/did/resolve-dids.md)
    * [Verify the integrity of DIDDocument](swift/developer-guide-with-sample-code/did/verify-the-integrity-of-diddocument.md)
    * [Create DID and DIDDocument](swift/developer-guide-with-sample-code/did/create-did-and-diddocument.md)
    * [Publish DID](swift/developer-guide-with-sample-code/did/publish-did.md)
    * [Create customized DID](swift/developer-guide-with-sample-code/did/create-customized-did.md)
    * [Create multi-signed customized DID](swift/developer-guide-with-sample-code/did/create-multi-signed-customized-did.md)
    * [Transfer the ownership of the customized DID](swift/developer-guide-with-sample-code/did/transfer-the-ownership-of-the-customized-did.md)
    * [Deactivate DID](swift/developer-guide-with-sample-code/did/deactivate-did.md)
  * [Credential and presentation](swift/developer-guide-with-sample-code/credential-and-presentation.md)
  * [Json Web Token](swift/developer-guide-with-sample-code/json-web-token.md)
  * [Advanced](swift/developer-guide-with-sample-code/advanced.md)
...
* [Developer Guide(with sample code)](javascript/developer-guide-with-sample-code/README.md)
  ...
  * [Json Web Token](javascript/developer-guide-with-sample-code/json-web-token.md)
  * [Advanced](javascript/developer-guide-with-sample-code/advanced.md)
  * [Credential and presentation](javascript/developer-guide-with-sample-code/credential-and-presentation.md)
  * [Metadata](javascript/developer-guide-with-sample-code/metadata.md)
  * [Full sample code](javascript/developer-guide-with-sample-code/full-sample-code.md)
* [API reference(link to javadoc)](javascript/api-reference-link-to-javadoc.md)
...
* [Developer Guide(with sample code)](c-c++/developer-guide-with-sample-code/README.md)
  ...
  * [DIDStore](c-c++/developer-guide-with-sample-code/didstore/README.md)
    ...
    * [Export/import DID](c-c++/developer-guide-with-sample-code/didstore/export-import-did.md)
    * [Export/import DIDStore](c-c++/developer-guide-with-sample-code/didstore/export-import-didstore.md)
  * [RootIdentity](c-c++/developer-guide-with-sample-code/rootidentity/README.md)
    * [Create RootIdentiy](c-c++/developer-guide-with-sample-code/rootidentity/create-rootidentiy.md)
  ...
  * [DID](c-c++/developer-guide-with-sample-code/did/README.md)
    ...
    * [Create DID and DIDDocument](c-c++/developer-guide-with-sample-code/did/create-did-and-diddocument.md)
  ...
  * [Credential and presentation](c-c++/developer-guide-with-sample-code/credential-and-presentation.md)
  * [Json Web Token](c-c++/developer-guide-with-sample-code/json-web-token.md)
  * [Advanced](c-c++/developer-guide-with-sample-code/advanced.md)
* [API reference(link to javadoc)](c-c++/api-reference-link-to-javadoc.md)
